      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 mb-16 md:mb-20">
          <Reveal className="md:col-span-7">
            ...
            <p className="mt-5 text-[10px] uppercase tracking-widest-xl text-sage-400">
              — Isaiah 40:31
            </p>
          </Reveal>
            ...
            <ul className="space-y-4 text-cream-100/85">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 hover:text-sage-400 transition-colors"
                >
...
function SocialLink({
  ...
  return (
    <a
      href={href}
      aria-label={label}
      className="text-cream-100/70 hover:text-sage-400 transition-colors"
    >
      {children}
    </a>
  );
