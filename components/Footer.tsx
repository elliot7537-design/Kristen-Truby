...
export function Footer() {
  return (
    <footer className="relative bg-forest-500 text-cream-50 pt-20 md:pt-28 pb-10 overflow-hidden grain">
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <RevealStagger className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-px bg-cream-50/10 mb-20 md:mb-28">
          {HOURS.map((h) => (
            <RevealItem key={h.day}>
              <div className="bg-forest-500 p-5 md:p-6 h-full flex flex-col justify-between min-h-[110px]">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 mb-16 md:mb-20">
          ...
          <Reveal className="md:col-span-4 md:col-start-9" delay={0.1}>
            ...
            <ul className="space-y-4 text-cream-50/85">
              ...
              <li className="flex items-center gap-3 text-cream-50/70">
        ...
        <div className="border-t border-cream-50/15 pt-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
