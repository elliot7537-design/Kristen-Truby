            ...
            <RevealItem key={p.title}>
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  ...
                  <p.icon
                    className="text-forest-600 transition-all duration-500 group-hover:text-sage-400 group-hover:rotate-[-6deg]"
                    size={28}
                    strokeWidth={1.25}
                  />
                </div>

                <div className="h-px w-12 bg-forest-700 mb-6 transition-all duration-500 group-hover:w-24 group-hover:bg-sage-400" />
