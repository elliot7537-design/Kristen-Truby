    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid md:grid-cols-12 gap-12 md:gap-16">
        ...
        <div className="md:col-span-4">
          ...
          <Reveal delay={0.25}>
            <div className="mt-8 flex items-start gap-3 text-ink-600 text-sm">
              <Clock size={16} strokeWidth={1.5} className="mt-0.5 shrink-0 text-forest-600" />
              <span>
                Kristen is based in California (Pacific Time). Calendly
                automatically converts her availability to your local timezone.
              </span>
            </div>
          </Reveal>
        ...
        <Reveal className="md:col-span-8" delay={0.15}>
          <div
            id="calendly-embed"
            className="calendly-inline-widget w-full rounded-none border border-ink-900/10"
